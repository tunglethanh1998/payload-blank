...
import PredictionDetailContainer from './container'

const PredictionDetail = ({ initPageResult, params, searchParams }: AdminViewServerProps) => {
  return (
    <DefaultTemplate
    ...
    >
      ...
      />
      <Gutter>
        <Header title="Prediction Detail" />
        <PredictionDetailContainer />
      </Gutter>
    </DefaultTemplate>
  )
}
